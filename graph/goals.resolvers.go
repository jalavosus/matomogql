...
func (r *goalResolver) ConvertedVisits(ctx context.Context, obj *model.Goal, opts *model.ConvertedVisitsOptions) ([]*model.VisitDetails, error) {
	return loaders.GetGoalConvertedVisits(ctx, obj.IDSite, obj.IDGoal, opts)
}
